...
const EditUser = () => {
  ...
  const updateUser = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`https://backendmedgis-94lt4q7ut-nadyahrxas-projects.vercel.app/users/${id}`, {
        Nama,
        Jenis,
        Kelas,
        Kapasitas,
  ...
  const getUsersById = async () => {
    try {
      const response = await axios.get(`https://backendmedgis-94lt4q7ut-nadyahrxas-projects.vercel.app/users/${id}`);
      if (response.data) {
