...
const UserList = () => {
    ...
    const getUsers = async (page) => {
        const response = await axios.get(`https://backendmedgis-94lt4q7ut-nadyahrxas-projects.vercel.app/users?page=${page}`);
    ...
    const deleteUser = async (id) => {
        ...
        if (confirmed) {
            try {
                await axios.delete(`https://backendmedgis-94lt4q7ut-nadyahrxas-projects.vercel.app/users/${id}`);
